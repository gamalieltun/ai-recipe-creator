...
const RecipeDisplay: React.FC<RecipeDisplayProps> = ({ recipe }) => {
    ...
    const EssentialIcon = () => (
        <span className="ml-2 text-green-600" title="Essential">
    ...
    const OptionalIcon = () => (
        <span className="ml-2 text-gray-400" title="Optional">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="w-full max-w-4xl mx-auto mt-10 bg-white p-8 rounded-xl shadow-2xl animate-fade-in-up">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div className="md:col-span-1">
                    <h3 className="text-2xl font-bold text-gray-700 mb-4 border-b-2 border-indigo-500 pb-2">Ingredients</h3>
                ...
                <div className="md:col-span-2">
                    <h3 className="text-2xl font-bold text-gray-700 mb-4 border-b-2 border-green-500 pb-2">Instructions</h3>
